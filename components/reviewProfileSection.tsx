    ...
    return (
        <div className="grid grid-cols-3 bg-[#003566] p-4 rounded-xl text-center">
            <div className="justify-self-center">
                <Image src={review.pelicula.urlImagen} alt="movie image" width="500" height="500" style={{ width: "auto", height: "auto" }} className="m-auto aspect-square mt-4 rounded-xl mb-3 !w-full"
            ...
            <div className="col-span-2 grid grid-rows-[auto_1fr_auto]">
                ...
                <div className="grid grid-cols-3 items-end mt-2">
                    <span className="text-[#f5c518] text-xl m-1">⭐{review.puntuacion}</span>
                    <button 
                    className="justify-self-center col-span-2 rounded-xl py-2 px-4 border border-transparent text-center text-sm text-white transition-all 
